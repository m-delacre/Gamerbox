 ...
 */
final class Version20240227233722 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD cover VARCHAR(255) DEFAULT NULL, CHANGE release_date release_date DATE DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game DROP cover, CHANGE release_date release_date DATE NOT NULL');
