 ...
 */
final class Version20240302144700 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE summary summary LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE summary summary LONGTEXT NOT NULL');
