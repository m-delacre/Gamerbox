 ...
 */
final class Version20240302140355 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game_mode ADD igdb_id INT NOT NULL');
        $this->addSql('ALTER TABLE genre ADD igdb_id INT NOT NULL');
        $this->addSql('ALTER TABLE theme ADD igdb_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game_mode DROP igdb_id');
        ...
        $this->addSql('ALTER TABLE genre DROP igdb_id');
        $this->addSql('ALTER TABLE theme DROP igdb_id');
    }
}
